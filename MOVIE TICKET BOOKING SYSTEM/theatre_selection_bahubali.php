...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    ...
    <li class="active" class="page-item" id="tue" name="TUESDAY,5 Feb"><a class="page-link" href="#">Tue,5 Feb</a></li>
    <li class="active" class="page-item" id="wed" name="WEDNESDAY,6 Feb"><a class="page-link" href="#">Wed,6 Feb</a></li>
  </ul>
</nav>    
</div>
...
<div class="A">
<p>Fun Cinemas:Sigma mall,Bengaluru &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <!--<button type="button" class="btn btn-info">10:20</button>  &nbsp; &nbsp; &nbsp; -->
<button type="button" class="btn btn-info" id="s1100" name="Fun Cinemas:sigma mall,11:00">11:00</button> &nbsp; &nbsp; &nbsp; &nbsp;
<button type="button" class="btn btn-info" id="s1200" name="Fun Cinemas:sigma mall,1:20">1:20</button>  &nbsp;  &nbsp; &nbsp; &nbsp;
<button type="button" class="btn btn-info" id="s7200" name="Fun Cinemas:sigma mall,7:20">7:20</button>  &nbsp; &nbsp; &nbsp; &nbsp;
</p>
</div>
    <hr>
    
<div class="A">
<p>Inox:Central,Jp Nagar &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button type="button" class="btn btn-info" id="c1020" name="Central:JP nagar,10:20">10:20</button> &nbsp; &nbsp; &nbsp; &nbsp;
<button type="button" class="btn btn-info" id="c1100" name=" Central:JP nagar,11:00">11:00</button> &nbsp; &nbsp; &nbsp; &nbsp;
<button type="button" class="btn btn-info" id="c1200" name="Central:JP nagar,11:20">1:20</button>  &nbsp;  &nbsp; &nbsp; &nbsp;
</p>
</div>
    <hr>
    
<div class="A">
<p>Cinepolis:Royal Meenakshi Mall&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	
<button type="button" class="btn btn-info" id="r1020" name="Royal Meenakshi  mall,10:20">10:20</button> &nbsp; &nbsp; &nbsp; &nbsp;
<button type="button" class="btn btn-info" id="r1100" name="Royal Meenakshi mall,11:00">11:00</button> &nbsp; &nbsp; &nbsp; &nbsp;
<button type="button" class="btn btn-info" id="r1200" name="Royal Meenakshi  mall,1:20">1:20</button>  &nbsp;  &nbsp; &nbsp; &nbsp;
</p>
</div>
    <hr>
