...
<div class="A">
<p>Cinepolis : Forum Shantiniketan,Bengaluru &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <!--<button type="button" class="btn btn-info">10:20</button>  &nbsp; &nbsp; &nbsp; -->
<button type="button" class="btn btn-info" id="f1100" name="Forum,11:00">11:00</button> &nbsp; &nbsp; &nbsp; &nbsp;
<button type="button" class="btn btn-info" id="f1200" name="Forum,1:20">1:20</button>  &nbsp;  &nbsp; &nbsp; &nbsp;
<button type="button" class="btn btn-info" id="f7200" name="Forum,7:20">7:20</button>  &nbsp; &nbsp; &nbsp; &nbsp;
</p>
</div>
    <hr>
    
<div class="A">
<p>Gopalan cinemas : Arcade mall,mysore road &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button type="button" class="btn btn-info" id="a1020" name="Arcade mall,10:20">10:20</button> &nbsp; &nbsp; &nbsp; &nbsp;
<button type="button" class="btn btn-info" id="a1100" name=" Arcade mall,11:00">11:00</button> &nbsp; &nbsp; &nbsp; &nbsp;
<button type="button" class="btn btn-info" id="a1200" name="Arcade mall,11:20">1:20</button>  &nbsp;  &nbsp; &nbsp; &nbsp;
</p>
</div>
    <hr>
...
<div class="A">
<p>Inox: Brookfield mall &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button type="button" class="btn btn-info" id="b1020" name="Brookfield mall,10:20">10:20</button> &nbsp; &nbsp; &nbsp; &nbsp;
<button type="button" class="btn btn-info" id="b1100" name="Brookfield mall,11:00">11:00</button> &nbsp; &nbsp; &nbsp; &nbsp;
<button type="button" class="btn btn-info" id="b1200" name="Brookfield mall,1:20">1:20</button>  &nbsp;  &nbsp; &nbsp; &nbsp;
</p>
</div>
    <hr>
	<script>
